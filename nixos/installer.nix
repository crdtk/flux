...
{
  # Self-installing USB. Boot it, log in as nixos, run: sudo serval-nixos-install
  # The script IS the procedure — every step fenced, nothing improvised at
  # the console. The flake itself rides along read-only at /etc/serval-flake.
